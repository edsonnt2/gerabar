<?php
/**
link myforadmin/_classes/vendor/pagseguro/pagseguro-php-sdk/public/Configuration/dynamicConfiguration.php
...
$emailPagseguro = (isset($emailPagseguro))?$emailPagseguro:'';
$token = (isset($token))?$token:''; //token teste SANDBOX
...
\PagSeguro\Configuration\Configure::setEnvironment($producao);//production or sandbox
