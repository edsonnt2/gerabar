<?php if(isset($_POST['inclui'])){ if(isset($_SESSION)==false){session_start(); }
	...
	$trasData=AbrirFecharCaixa::DataCaixaFechado($idEmpresa);
	...
	$countCmdAbertas=AbrirFecharCaixa::dadosCaixa($idEmpresa,0,$dataInicial,$dataFinal);
...
<div id="tudo_cmd_aberta">
 ...
 <div class="info_topo_cad"><h1>Caixas em Aberto</h1></div><!--fecha info topo cad-->

<?php 
$pgOndefiltra='caixas-abertos';
...
<?php
	...
	$cmdAbertas=AbrirFecharCaixa::buscaCaixaFechadas($_GET["busca"],$idEmpresa);
	...
	$cmdAbertas=AbrirFecharCaixa::dadosCaixa($idEmpresa,0,$dataInicial,$dataFinal,$inicio,$maximo);
	$numCmd=$cmdAbertas['num'];
