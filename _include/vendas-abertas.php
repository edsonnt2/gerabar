<?php if(isset($_POST['inclui'])){ if(isset($_SESSION)==false){session_start(); }
	...
	$trasData=FrenteCaixa::DataCaixaFechado($idEmpresa,"frente_caixa");
	...
	$countCmdAbertas=FrenteCaixa::selFrenteAberta($idEmpresa,true,$dataInicial,$dataFinal);
...
<div id="tudo_cmd_aberta">
 ...
 <div class="info_topo_cad"><h1>Vendas em Aberto</h1></div><!--fecha info topo cad-->

<?php 
$pgOndefiltra='vendas-abertas';
...
<?php
	...
	$cmdAbertas=FrenteCaixa::buscaCaixaFechadas($_GET["busca"],$idEmpresa,false);
	...
	$cmdAbertas=FrenteCaixa::selFrenteAberta($idEmpresa,true,$dataInicial,$dataFinal,$inicio,$maximo,true);
	$numCmd=$cmdAbertas['num'];
